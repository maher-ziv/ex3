...
//     mtm::IntMatrix tmp = *this; //TODO test it if this works !! for
//     (mtm::IntMatrix::iterator it = tmp.begin(); it != tmp.end(); ++it) {
//     //TODO pick one
//         (*it) *= -1;
//     }
//     return tmp;
...
//     if ( a.size() > b.size() ) {  // matrix a and b not from the same
//     dimension which mean casting happened and dime of b is one i.e. 1x1
//         for ( mtm::IntMatrix::iterator it_a = (*this).begin(); it_a !=
//         a.end(); ++it_a) {
//             *it_a += b(0, 0);
//         }
//     } else {
//         for (mtm::IntMatrix::iterator it_a = this->begin(), it_b = b.begin();
...
//     //if casting happened and dime of a or b is one i.e. 1x1  , this mean
//     that the user want to add scalar mtm::IntMatrix tmp_1 = a.size() >=
//     b.size() ? a : b; mtm::IntMatrix tmp_2 = tmp_1.size() == a.size() ? b :
