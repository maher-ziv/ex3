...
namespace mtm {
    ...
    class Matrix<T>::DimensionMismatch : public std::exception {
       ...
       public:
        DimensionMismatch (Dimensions dim1, Dimensions dim2) : dimension1 (dim1), dimension2 (dim2) ,err (nullptr){}
     ...
     *  @param  initial_val initial value of all elements
     *
     ...
     *  @param  m   Matrix of identical element type .
     *
     ...
     *
     *  All the elements of @param m are copied.
     *  Whether the elements are copied depends on the assigment operator of T
     */
    template<typename T>
     ...
     *
     *this operator works only on classes that operator '-' effects their elements
     */
    template<class T>
     ...
     *  @param x  'x' is the value which operator '<' checks
     *
    ...
    */
     ...
     *            false otherwise.
     *
     * This Method assume type @T have operator! 
     */
    template<typename T>
     ...
     *            false otherwise.
     *
     * This Method assume type @T have converter from type T to type bool  
     */
    template<typename T>
    ...
    class Matrix<T>::T_iterator {
       ...
       public:
        T_iterator& operator= (const T_iterator& it) = default;  
        T_iterator (const T_iterator& it) = default;           
